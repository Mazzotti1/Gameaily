...
class GameOverFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val minigamesButton = view.findViewById<Button>(R.id.minigames)
        minigamesButton.setOnClickListener {
            findNavController().navigate(R.id.action_gameOverFragment_to_minigamesNavbar)
        }
